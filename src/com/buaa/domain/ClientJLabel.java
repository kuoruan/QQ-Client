...
public class ClientJLabel extends JLabel {
    ...
    public ClientJLabel(String name, int x, int y, int width, int height, int size, Color fontColor) {
        super();
        this.name = name;
        this.x = x;
        this.y = y;
    ...
    public ClientJLabel(String name, int x, int y, int width, int height, int size) {
        super();
        this.name = name;
        this.x = x;
        this.y = y;
    ...
    public ClientJLabel(String name, int x, int y, int width, int height, Color fontColor) {
        super();
        this.name = name;
        this.x = x;
        this.y = y;
